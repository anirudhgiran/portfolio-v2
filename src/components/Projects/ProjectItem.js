    ...
    const projectList = [
        {
            ...
            demoURL: "https://twitter-spoof.web.app/",
        },
        {
            heading: "TMDB App",
            backdropText: "TMDB App",
            details:
                "An Angular application that lists the latest movies, tv shows and popular artists. The application uses The Movie DB API to fetch data.",
        ...
        },
        {
            ...
            details:
                "An attempt at creating a website using dfferent shades of a color along with black and white.",
            ...
            {projectList.map((item, index) => (
                <div className="projects-list-item" key={index}>
                    <h1 className="counter">
                        <span>{index + 1}</span> of {projectList.length}
                    </h1>
                    <h1 className="heading" data-backdrop={item.backdropText}>
                        {item.heading}
                    </h1>
                    <p>{item.details}</p>
                    <div className="links">
